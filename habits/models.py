...
class Habit(models.Model):
    ...
    human = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='habits', on_delete=models.CASCADE, **NULLABLE, verbose_name='Пользователь')
    location = models.CharField(max_length=255, **NULLABLE, verbose_name='Место привычки')
    ...
    frequency = models.CharField(max_length=5, default='ONE', choices=FREQUENCY_CHOICES, **NULLABLE)
    reward = models.CharField(max_length=255, **NULLABLE, verbose_name='Вознаграждение')
    duration = models.PositiveIntegerField(**NULLABLE, verbose_name='Время на выполнение')
